...
function handleSrcOverride(element, value, originalSetAttribute) {
    if (value === 'https://source.zoom.us/3.13.1/lib/av/js_media.min.js') {
        const localUrl = chrome.runtime.getURL('/zoom/3.13.1/lib/av/js_media.min.js');
    ...
    if (value.startsWith('https://zoom.us/api/v1/wc/info')) {
        ...
        console.log('[Zoom Intercept] Fetching data from proxy:', proxyUrl.toString());
